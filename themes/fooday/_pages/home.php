...
<div id="pagewrap" class="pagewrap">
	<div id="html-content" class="wrapper-content">
		<header class="header-transparent">
			...
			<div class="container">
				...
				<div class="header-logo">
					<a href="index.html" class="logo logo-static">
						<img src="<?= theme_url('fooday/assets/images/logo-white.png') ?>" alt="fooday" class="logo-img">
					</a>
					<a href="index.html" class="logo logo-fixed">
						<img src="<?= theme_url('fooday/assets/images/logo.png') ?>" alt="fooday" class="logo-img">
					</a>
				</div>
		...
		<div class="page-container">
			...
			<div data-parallax="scroll" data-image-src="<?= theme_url('fooday/assets/images/slider/slider2-bg1.jpg') ?>" class="slides parallax-window">
				<div class="slide-content slide-layout-02">
				<div class="container">
					<div class="slide-content-inner"><img src="<?= theme_url('fooday/assets/images/slider/slider2-icon.png') ?>" data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="500" alt="fooday" class="slide-icon img img-responsive animated">
			...
			<section class="about-us-session padding-top-100 padding-bottom-100">
				<div class="container">
				<div class="row">
					<div class="col-md-6 colsm-12"><img src="<?= theme_url('fooday/assets/images/pages/home1-about.jpg') ?>" alt="" class="img img-responsive wow zoomIn"></div>
					...
					<div class="row">
						...
						<div class="swin-sc swin-sc-testimonial style-1">
							...
							<ul class="slides list-inline">
								<li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="<?= theme_url('fooday/assets/images/testi/testi-1.jpg') ?>" alt="fooday" class="img img-responsive swin-transition"></a></li>
								<li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="<?= theme_url('fooday/assets/images/testi/testi-2.jpg') ?>" alt="fooday" class="img img-responsive swin-transition"></a></li>
								<li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="<?= theme_url('fooday/assets/images/testi/testi-3.jpg') ?>" alt="fooday" class="img img-responsive swin-transition"></a></li>
								<li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="<?= theme_url('fooday/assets/images/testi/testi-4.jpg') ?>" alt="fooday" class="img img-responsive swin-transition"></a></li>
							</ul>
							</div>
						</div>
						</div>
				...
				<div class="row">
					...
					<div class="swin-sc swin-sc-team-slider">
						...
						<div class="team-img-wrap">
							<div class="team-img"><img src="<?= theme_url('fooday/assets/images/team/team-1.png') ?>" alt="" class="img img-responsive"></div>
						</div>
						...
						<div class="team-img-wrap">
							<div class="team-img"><img src="<?= theme_url('fooday/assets/images/team/team-2.png') ?>" alt="" class="img img-responsive"></div>
						</div>
						...
						<div class="team-img-wrap">
							<div class="team-img"><img src="<?= theme_url('fooday/assets/images/team/team-3.png') ?>" alt="" class="img img-responsive"></div>
						</div>
						...
						<div class="team-img-wrap">
							<div class="team-img"><img src="<?= theme_url('fooday/assets/images/team/team-4.png') ?>" alt="" class="img img-responsive"></div>
						</div>
						<p class="team-name">Teresa Doe</p>
						<p class="team-position">Head Chef</p>
						<hr>
			...
			<section class="reservation-section-02 padding-top-100 padding-bottom-100">
				<div class="container"><img src="<?= theme_url('fooday/assets/images/background/home2-img-deco.png') ?>" alt="" class="img-deco img-responsive">
				<div class="row">
			...
			<section class="gallery-section-01 padding-top-100">
				...
				<div class="grid">
					...
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-1.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-1.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
					<div class="grid-item col-sm-4 grid-item-h1">
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-2.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-2.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
					<div class="grid-item col-sm-2 grid-item-h1">
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-3.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-3.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
					<div class="grid-item col-sm-3 grid-item-h2">
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-4.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-4.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
					<div class="grid-item col-sm-2 grid-item-h1">
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-5.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-5.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
					<div class="grid-item col-sm-4 grid-item-h1">
					<div class="grid-wrap-item"><a href="#" class="gallery-title title">Chicago Beefsteak</a><a href="<?= theme_url('fooday/assets/images/gallery/gallery-6.jpg') ?>" data-lightbox="image" class="view-lightbox swipebox"><i class="fa fa-search-plus"></i></a><a href="#" class="view-more"><i class="fa fa-link"></i></a>
						<div class="img-wrap"><img src="<?= theme_url('fooday/assets/images/gallery/gallery-6.jpg') ?>" alt="" class="img img-responsive"></div>
					</div>
					</div>
				</div>
				</div>
				...
				<div class="row">
					...
					<div class="swin-sc swin-sc-blog-grid">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<div class="blog-featured-img"><img src="<?= theme_url('fooday/assets/images/blog/blog-grid-1.jpg') ?>" alt="fooday" class="img img-responsive"></div>
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<div class="blog-featured-img"><img src="<?= theme_url('fooday/assets/images/blog/blog-grid-1-1.jpg') ?>" alt="fooday" class="img img-responsive"></div>
							<div class="blog-content">
								<div class="blog-date"><span class="day">12</span><span class="month">Jun</span></div>
								<h3 class="blog-title"><a href="javascript:void(0)" class="swin-transition">How To Cook The Spicy Chinese Noodle For Cold Weather</a></h3>
								<p class="blog-description">Lorem ipsum dolor sit amet, consectetur, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							...
							<div class="blog-featured-img"><img src="<?= theme_url('fooday/assets/images/blog/blog-grid-1-2.jpg') ?>" alt="fooday" class="img img-responsive"></div>
							<div class="blog-content">
								<div class="blog-date"><span class="day">12</span><span class="month">Jun</span></div>
								<h3 class="blog-title"><a href="javascript:void(0)" class="swin-transition">How To Cook The Spicy Chinese Noodle For Cold Weather</a></h3>
								<p class="blog-description">Lorem ipsum dolor sit amet, consectetur, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		...
		<footer>
			<div class="subscribe-section"><img src="<?= theme_url('fooday/assets/images/background/bg5.png') ?>" alt="" class="img-subscribe">
			<div class="container">
				<div class="subscribe-wrapper">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2">
					<div class="subscribe-heading">
						<h3 class="title">Subcribe Us own</h3>
			...
			<div class="container">
				...
				<div class="col-lg-8">
					...
					<div class="ft-area1">
						...
						<div class="clearfix"><a class="wget-logo"><img src="<?= theme_url('fooday/assets/images/logo-ft.png') ?>" alt="" class="img img-responsive"></a>
